import 'dart:io';
import 'package:face_detection_app/View/face_match_live_view.dart';
import 'package:face_detection_app/View/facedetector.dart';
...
class _HomePageState extends State<RecognitionScreen> {
  ...
  doFaceDetection() async {
    ...
    for (Face face in faces) {
      ...
      Recognition recognition = await recognizer.recognize(croppedFace, boundingBox);
      ...
      print('mesafe = ${recognition.distance}');
      print('-----------------------------------');
    }
